...
function generateAvatarBuffer(domain, themeIndex, glass, logo) {
  ...
  // ✅ FIX 1: Fill with solid white FIRST so PNG alpha → JPEG conversion
  // doesn't produce a black image in Telegram
  ...
  // ✅ FIX 2: Return JPEG buffer — Telegram handles it perfectly, no black pixels
  return canvas.toBuffer('image/jpeg', { quality: 0.95 });
}

module.exports = { generateAvatarBuffer, themes };
